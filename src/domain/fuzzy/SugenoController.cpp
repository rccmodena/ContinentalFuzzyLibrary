...
const std::map<QString, variable::SugenoInput>& SugenoController::getSugenoInputs() const
{
    return m_sugenoInputs;
}

void SugenoController::setSugenoInputs(const std::map<QString, variable::SugenoInput> &sugenoInputs)
{
...
const std::map<QString, variable::SugenoOutput>& SugenoController::getSugenoOutputs() const
{
    return m_sugenoOutputs;
}

void SugenoController::setSugenoOutputs(const std::map<QString, variable::SugenoOutput> &sugenoOutputs)
{
